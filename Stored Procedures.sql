...
DELIMITER //
CREATE PROCEDURE InserirToken(vIdUsuario INT, vToken VARCHAR(255))
BEGIN
	DECLARE lValidade DATETIME;
    SET lValidade = now() + INTERVAL 3 DAY;
	
	INSERT INTO tokens (idUsuario, token, validade)
	VALUES (vIdUsuario, vToken, lValidade);
...
DELIMITER //
CREATE PROCEDURE TrocarSenha(vIdUsuario INT, vSenha VARCHAR(255))
BEGIN
...
BEGIN
	...
	VALUES (lTime, vIdUsuario, 0, CONCAT("Registro de Transferencia #", lId), vValor);
...
BEGIN
	...
	VALUES (vIdPersonagem, vIdUsuario, 0, lTime, CONCAT("Registro Credito Personagem #", vIdPersonagem), vQuantidade, lPrecoUnitario);
...
BEGIN
	...
	INSERT INTO lancamentosPersonagem (idPersonagem, idUsuario, operacao, data, historico, quantidade, precoUnitario)
	VALUES (vIdPersonagem, vIdUsuario, 1, lTime, CONCAT("Reg Debito Personagem #", vIdPersonagem), vQuantidade, lPrecoUnitario);
