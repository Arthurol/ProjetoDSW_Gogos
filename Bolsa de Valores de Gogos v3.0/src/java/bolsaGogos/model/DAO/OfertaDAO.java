...
import bolsaGogos.model.interfaces.DAO.OfertaDAOInterface;
...
public class OfertaDAO implements OfertaDAOInterface {
    ...
    */
    private Oferta montaOferta(ResultSet rs) throws SQLException
    {
        ...
        oferta.setData(new DateTime(rs.getDate("data")));
    ...
    /**
     * Remove Oferta do Banco de acordo com o id informado     
     */
    @Override
    public boolean removeOferta(int id) {
         ...
         try (Connection conn = config.conectar()){
            ...
            PreparedStatement ps = conn.prepareStatement("DELETE FROM ofertas WHERE id=?"); 
            ps.setInt(1, id);
            ps.executeQuery();
